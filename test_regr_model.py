...
get_model("gru32", num_words, emb_matrix, max_length).summary()
get_model("gru100", num_words, emb_matrix, max_length ).summary()
get_model("doublegru", num_words, emb_matrix, max_length).summary()
